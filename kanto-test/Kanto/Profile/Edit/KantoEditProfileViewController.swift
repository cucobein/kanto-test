...
private extension KantoEditProfileViewController {
    ...
    func bindViews() {
        ...
        _ = changePhotoButton.reactive.controlEvents(.touchUpInside).observeNext { [weak self] in
            guard let self = self else { return }
...
extension KantoEditProfileViewController: UIImagePickerControllerDelegate {
...
extension KantoEditProfileViewController: UINavigationControllerDelegate { }
